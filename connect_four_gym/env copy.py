...
class C4Env(Env):
    ...
    def __init__ (self):
        ...
        self.observation_space = Discrete(NUM_LOCS)
    ...
    def step(self, action):
        ...
        if self.done:
            return self.__get_obs(), 0, True, None # observation, reward, done, info 
        reward = NO_REWARD
        ...
        return self.__get_obs(), reward, self.done, None
    ...
    def _show_result(self, result, color, print_or_log):
        ...
        print_or_log('')
    def __get_obs(self):
        return tuple(self.board), self.color
